...
class GasBuddy:
    ...
    def __init__(
        self, station_id: int | None = None, cookie_file: str | None = None
    ) -> None:
        self._url = BASE_URL
        self._id = station_id
    ...
    async def process_request(
        ...
        async with aiohttp.ClientSession(
            headers=headers, cookies=self.cookie_jar
        ) as session:
    ...
    async def location_search_prices(
        self,
        lat: float | None = None,
        lon: float | None = None,
        zipcode: int | None = None,
    ...
    async def price_lookup(self) -> dict[str, Any] | None:
        ...
        for price in data["prices"]:
            ...
            formatted[index] = {
                ...
                "cash_price": (
                    price.get("cash", {}).get("price") if price.get("cash") else None
                ),
